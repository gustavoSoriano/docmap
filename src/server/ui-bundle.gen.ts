...
<div id="chat-panel">
  <div id="chat-header">
    <span id="chat-title"><span data-icon="bot"></span> gemma4:12b</span>
...
const MODE_LABEL = { map: 'Mapa', notes: 'Notas', macros: 'Macros', skills: 'Skills', diagrams: 'Diagramas' };
...
const renderMarkmap = (markdown, tries = 0) => {
  ...
  window._markmap = mk.Markmap.create(svg, { autoFit: true }, root);
